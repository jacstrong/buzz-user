        ...
        >
          <v-row row wrap>
            ...
            <v-col cols="3" class="justify-right">
              ...
              <v-btn icon text tile small color="black lighten-2"><v-icon>notification_important</v-icon></v-btn>
              <v-btn icon text tile small color="warning"><v-icon>delete</v-icon></v-btn>
            </v-col>
          </v-row>
